@echo off
REM =============================================================================
REM run_proofs.bat — Run all Kani formal verification proofs for Kelvin
REM
REM Runs all 56 proof harnesses across 7 proof files in kelvin-core.
REM Requires Kani Rust Verifier: https://model-checking.github.io/kani/
REM
REM Usage:
REM   scripts\run_proofs.bat          — Run all proofs (full verification)
REM   scripts\run_proofs.bat --fast   — Run only fixed_equivalence proofs
REM   scripts\run_proofs.bat --list   — List all proof harnesses
REM =============================================================================
setlocal enabledelayedexpansion

set KANI_ARGS=--enable-unstable --restrict-vtable
set PROOF_DIR=%~dp0..\proofs\kani
