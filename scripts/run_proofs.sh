...
#
# Runs all 62 proof harnesses across 9 proof files in kelvin-core.
...
list_harnesses() {
    ...
    echo "==============================================================================="
    echo ""
    echo " fixed_equivalence.rs (5) — Q32.64 arithmetic functional equivalence:"
    ...
    echo ""
    echo " acceleration_proofs.rs (3) — compute_accelerations composite proofs:"
    echo "   verify_acceleration_single_body"
    echo "   verify_acceleration_two_body"
    echo "   verify_acceleration_newton_third"
    echo ""
    echo " vec3_proofs.rs (18) — Vec3 vector operation proofs:"
    ...
    echo ""
    echo " integrator_proofs.rs (9) — Verlet + Euler integrator proofs:"
    ...
    echo ""
    echo " stability_proofs.rs (6) — Ejection + collapse detection proofs:"
    ...
    echo ""
    echo " extraction_proofs.rs (7) — Entropy extraction safety proofs:"
    ...
    echo ""
    echo " orbital_state_proofs.rs (8) — OrbitalState safety proofs:"
...
run_fast() {
    echo "==============================================================================="
    echo " KELVIN FORMAL VERIFICATION — Fast mode (5 fixed_equivalence proofs)"
    echo "==============================================================================="
    echo ""
