...
| # | Gap | File | Status |
|---|-----|------|--------|
| 1 | Extend Ambainis' adversary method | [`gap1_ambainis_adversary`](gap1_ambainis_adversary.md) | ✅ RESOLVED |
| 2 | $\Omega(2^{S \cdot k/2})$ lower bound | [`gap2_quantum_query_lower_bound`](gap2_quantum_query_lower_bound.md) | ✅ RESOLVED |
| 3 | Relate $k$ to C1's $\varepsilon$-bound | [`gap3_c1_c3_link`](gap3_c1_c3_link.md) | ✅ RESOLVED |
