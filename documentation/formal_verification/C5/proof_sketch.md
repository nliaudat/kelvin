...
4. **Non-collision**: $r_i \neq r_j$ for $i \neq j$
5. **Minimum separation**: $|r_i - r_j| \ge \text{min-separation}$
...
| # | Gap | File | Status |
|---|-----|------|--------|
| 1 | Cardinality $|\Theta_5| \ge 2^{1920}$ | [`gap1_cardinality_bound`](gap1_cardinality_bound.md) | ✅ RESOLVED |
| 2 | Min-entropy $H_{\min} \ge 1800$ bits | [`gap2_min_entropy`](gap2_min_entropy.md) | ✅ RESOLVED |
